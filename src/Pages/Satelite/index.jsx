...
const Satelite = () => {
  return (
    <section className=' w-[90%] min-w-[280px] max-w-[800px] flex flex-col gap-5 justify-center items-center mb-10'>
      ...
      <h2 className='text-[2.2rem] font-bold pt-10'>Colaboradores:</h2>
      ...
      <h2 className='text-[2.2rem] font-bold pt-10'>Te invito a seguirlos en sus redes sociales y conocer que tienen preparado para tí en su página web:</h2>
